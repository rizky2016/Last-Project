...
<body>
    ...
    <div class="navbar">
        ...
        <a href="index.php"><p class="actived" class="women">Women</p></a>
        ...
        <div class="watch-list">
            <table>
                <tr>
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='1'";
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='2'";
                        $result = mysqli_query($connect, $query);
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='3'";
                        $result = mysqli_query($connect, $query);
                ...
                <tr>
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='4'";
                        $result = mysqli_query($connect, $query);
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='5'";
                        $result = mysqli_query($connect, $query);
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='6'";
                        $result = mysqli_query($connect, $query);
                ...
                <tr>
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='7'";
                        $result = mysqli_query($connect, $query);
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='8'";
                        $result = mysqli_query($connect, $query);
                    ...
                    <td>
                        <?php
                        $query = " SELECT * FROM women_watch WHERE id='9'";
                        $result = mysqli_query($connect, $query);
