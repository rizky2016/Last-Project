...
$id = $_GET['id'];
$sql = "SELECT * FROM women_watch WHERE id = '$id'";
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <form action="edit2.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-email-input" class="col-md-2 col-form-label">Masukkan Nama</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="nama" id="example-email-input" value="<?php echo $data['nama']?>"/>
                                            </div>
                                        </div><!-- end row -->
                                        <div class="mb-3 row">
                                            <label for="example-url-input" class="col-md-2 col-form-label">Masukkan Harga</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="harga" id="example-url-input" value="<?php echo $data['harga']?>"/>
                                            </div>
                                        <div class="row justify-content-end">
                                            <div class="col-sm-9">
                                                <div>
                                                    <input type="submit" name="edit2" value="Upload" class="btn btn-primary w-md">
                                                </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                    </form><!-- end form -->
