        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <?php
                    ...
                    while($women_w = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$women_w['id']."</td>";
                        echo "<td>".$women_w['gambar']."</td>";
                        echo "<td>".$women_w['nama']."</td>";
                        echo "<td>".$women_w['harga']."</td>";

                        echo "<td>";
                        echo "<a class='btn btn-outline-success' href='formedit2.php?id=".$women_w['id']."'>Edit</a> | ";
                        echo "<a class='btn btn-outline-warning' href='delete2.php?id=".$women_w['id']."'>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
